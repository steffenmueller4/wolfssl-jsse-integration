...
public class TestWolfSSLCipherSuiteList {
	...
	public void testWolfSSLCipherSuiteList2() {
		...
		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256" });
		assertTrue("ECDHE-ECDSA-AES128-GCM-SHA256".equals(s));

		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384" });
		...
		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256" });
		...
		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256" });
		...
		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256" });
		...
		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384" });
		...
		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256" });
		assertTrue("ECDHE-RSA-CHACHA20-POLY1305".equals(s));

		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256" });
		assertTrue("ECDHE-ECDSA-CHACHA20-POLY1305".equals(s));

		s = WolfSSLCipherSuiteList
				.getWolfSSLCipherSuiteList(new String[] { "TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256" });
		assertTrue("DHE-RSA-CHACHA20-POLY1305".equals(s));
	}

	@Test
	public void testConcatenation1() {
		String s = WolfSSLCipherSuiteList.getWolfSSLCipherSuiteList(new String[] {
				"TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256", "TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256" });
		...
		assertTrue(
				"DHE-RSA-CHACHA20-POLY1305:ECDHE-ECDSA-CHACHA20-POLY1305:ECDHE-RSA-CHACHA20-POLY1305:ECDH-ECDSA-AES256-SHA384"
						.equals(s));
	}

	@Test
	public void testConcatenation2() {
		String[] s = WolfSSLCipherSuiteList
				.getJavaCipherSuiteList("DHE-RSA-CHACHA20-POLY1305:ECDHE-ECDSA-CHACHA20-POLY1305");
		assertTrue(Arrays.equals(s, new String[] { "TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256",
				"TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256" }));

		s = WolfSSLCipherSuiteList.getJavaCipherSuiteList(
				"DHE-RSA-CHACHA20-POLY1305:ECDHE-ECDSA-CHACHA20-POLY1305:ECDHE-RSA-CHACHA20-POLY1305");
		assertTrue(Arrays.equals(s,
				new String[] { "TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256",
						"TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256",
